...
Original Plugin URI: http://www.simplesharebuttons.com
Original Description: A simple plugin that enables you to add share buttons to all of your posts and/or pages.
Original Version: 4.6
Original Author: David S. Neal
Original Author URI: http://www.davidsneal.co.uk/
Original License: GPLv2

Original Copyright 2014 Simple Share Buttons admin@simplesharebuttons.com
...
*/
    ...
    function ssba_activate() {
            ...
            add_option('ssba_custom_email_hover',        '');
            add_option('ssba_custom_google', 		'');
            add_option('ssba_custom_google_hover',        '');
            add_option('ssba_custom_facebook', 		'');
            add_option('ssba_custom_facebook_hover',        '');
            add_option('ssba_custom_twitter', 		'');
            add_option('ssba_custom_twitter_hover',        '');
            add_option('ssba_custom_diggit', 		'');
            add_option('ssba_custom_diggit_hover',        '');
            add_option('ssba_custom_linkedin', 	  	'');
            add_option('ssba_custom_linkedin_hover',        '');
            add_option('ssba_custom_reddit', 	  	'');
            add_option('ssba_custom_reddit_hover',        '');
            add_option('ssba_custom_stumbleupon', 	'');
            add_option('ssba_custom_stumbleupon_hover',        '');
            add_option('ssba_custom_pinterest', 	'');
            add_option('ssba_custom_pinterest_hover',        '');
            add_option('ssba_custom_buffer', 		'');
            add_option('ssba_custom_buffer_hover',        '');
            add_option('ssba_custom_flattr', 		'');
            add_option('ssba_custom_flattr_hover',        '');
            add_option('ssba_custom_tumblr', 		'');
            add_option('ssba_custom_tumblr_hover',        '');
            add_option('ssba_custom_print', 		'');
            add_option('ssba_custom_print_hover',        '');
    }
    ...
    function ssba_uninstall() {
            ...
            delete_option('ssba_custom_email_hover');
            delete_option('ssba_custom_google');
            delete_option('ssba_custom_google_hover');
            delete_option('ssba_custom_facebook');
            delete_option('ssba_custom_facebook_hover');
            delete_option('ssba_custom_twitter');
            delete_option('ssba_custom_twitter_hover');
            delete_option('ssba_custom_diggit');
            delete_option('ssba_custom_diggit_hover');
            delete_option('ssba_custom_linkedin');
            delete_option('ssba_custom_linkedin_hover');
            delete_option('ssba_custom_reddit');
            delete_option('ssba_custom_reddit_hover');
            delete_option('ssba_custom_stumbleupon');
            delete_option('ssba_custom_stumbleupon_hover');
            delete_option('ssba_custom_pinterest');
            delete_option('ssba_custom_pinterest_hover');
            delete_option('ssba_custom_buffer');
            delete_option('ssba_custom_buffer_hover');
            delete_option('ssba_custom_flattr');
            delete_option('ssba_custom_flattr_hover');
            delete_option('ssba_custom_tumblr');
            delete_option('ssba_custom_tumblr_hover');
            delete_option('ssba_custom_print');
            delete_option('ssba_custom_print_hover');
    }
    ...
    function ssba_settings() {
            ...
            if (isset($_POST['ssba_options'])) {
                    ...
                    if (!isset($_POST['ssba_save_nonce']) || !wp_verify_nonce($_POST['ssba_save_nonce'], 'ssba_save_settings')) {
                            ...
                            update_option('ssba_custom_email_hover', 	$_POST['ssba_custom_email_hover']);
                            update_option('ssba_custom_google', 		$_POST['ssba_custom_google']);
                            update_option('ssba_custom_google_hover', 	$_POST['ssba_custom_google_hover']);
                            update_option('ssba_custom_facebook', 		$_POST['ssba_custom_facebook']);
                            update_option('ssba_custom_facebook_hover', 	$_POST['ssba_custom_facebook_hover']);
                            update_option('ssba_custom_twitter', 		$_POST['ssba_custom_twitter']);
                            update_option('ssba_custom_twitter_hover', 	$_POST['ssba_custom_twitter_hover']);
                            update_option('ssba_custom_diggit', 		$_POST['ssba_custom_diggit']);
                            update_option('ssba_custom_diggit_hover', 	$_POST['ssba_custom_diggit_hover']);
                            update_option('ssba_custom_linkedin', 		$_POST['ssba_custom_linkedin']);
                            update_option('ssba_custom_linkedin_hover', 	$_POST['ssba_custom_linkedin_hover']);
                            update_option('ssba_custom_reddit', 		$_POST['ssba_custom_reddit']);
                            update_option('ssba_custom_reddit_hover', 	$_POST['ssba_custom_reddit_hover']);
                            update_option('ssba_custom_stumbleupon', 	$_POST['ssba_custom_stumbleupon']);
                            update_option('ssba_custom_stumbleupon_hover', 	$_POST['ssba_custom_stumbleupon_hover']);
                            update_option('ssba_custom_pinterest', 		$_POST['ssba_custom_pinterest']);
                            update_option('ssba_custom_pinterest_hover', 	$_POST['ssba_custom_pinterest_hover']);
                            update_option('ssba_custom_buffer', 		$_POST['ssba_custom_buffer']);
                            update_option('ssba_custom_buffer_hover', 	$_POST['ssba_custom_buffer_hover']);
                            update_option('ssba_custom_flattr', 		$_POST['ssba_custom_flattr']);
                            update_option('ssba_custom_flattr_hover', 	$_POST['ssba_custom_flattr_hover']);
                            update_option('ssba_custom_tumblr', 		$_POST['ssba_custom_tumblr']);
                            update_option('ssba_custom_tumblr_hover', 	$_POST['ssba_custom_tumblr_hover']);
                            update_option('ssba_custom_print', 		$_POST['ssba_custom_print']);
                            update_option('ssba_custom_print_hover', 	$_POST['ssba_custom_print_hover']);
    ...
    if ($arrSettings['ssba_selected_buttons'] != '') {
        ...
        foreach ($arrSelectedSSBA as $strSelected) {
            $method = "ssba_".$strSelected;
            $htmlShareButtons .= $method($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount);
        }
    }
...
function ssba_generate_service_style($service, $id, $arrSettings){
    $htmlShareStyle = '<style>';
    $htmlShareStyle .= '#'.$id . ' {';
...
function ssba_facebook($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    $htmlShareStyle = ssba_generate_service_style('facebook', $rndid, $arrSettings);

    // facebook share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_share_link ssba_facebook_share" href="http://www.facebook.com/sharer.php?u=' . $urlCurrentPage  . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? ' rel="nofollow"' : NULL) .'></a>';
...
function ssba_twitter($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
	...
	$twitterShareText = urlencode(html_entity_decode($strPageTitle . ' ' . $arrSettings['ssba_twitter_text'], ENT_COMPAT, 'UTF-8'));
        ...
        $htmlShareStyle = ssba_generate_service_style('twitter', $rndid, $arrSettings);

	// twitter share link
	$htmlShareButtons = '<a id="'.$rndid.'" class="ssba_share_link ssba_twitter_share" href="http://twitter.com/share?url=' . $urlCurrentPage . '&amp;text=' . $twitterShareText . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
...
function ssba_google($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
        $rndid = randCSSName();
        $htmlShareStyle = ssba_generate_service_style('google', $rndid, $arrSettings);

	// google share link
	$htmlShareButtons = '<a id="'.$rndid.'" class="ssba_share_link ssba_google_share" href="https://plus.google.com/share?url=' . $urlCurrentPage  . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
...
function ssba_diggit($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("diggit", $rndid, $arrSettings);
    // diggit share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_diggit_share ssba_share_link" href="http://www.digg.com/submit?url=' . $urlCurrentPage  . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
    // return share buttons
    return $htmlShareStyle . $htmlShareButtons;
}
...
function ssba_reddit($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("reddit", $rndid, $arrSettings);
    // reddit share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_reddit_share ssba_share_link" href="http://reddit.com/submit?url=' . $urlCurrentPage  . '&amp;title=' . $strPageTitle . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
...
function ssba_linkedin($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("linkedin", $rndid, $arrSettings);
    
    // linkedin share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_linkedin_share ssba_share_link" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=' . $urlCurrentPage  . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
    // if show share count is set to Y
    if ($arrSettings['ssba_show_share_count'] == 'Y' && $booShowShareCount == true) {
...
function ssba_stumbleupon($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("stumbleupon", $rndid, $arrSettings);

    // stumbleupon share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_stumbleupon_share ssba_share_link" href="http://www.stumbleupon.com/submit?url=' . $urlCurrentPage  . '&amp;title=' . $strPageTitle . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
...
function ssba_email($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("email", $rndid, $arrSettings);
    
    // email share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_email_share ssba_share_link" href="mailto:?Subject=' . $strPageTitle . '&amp;Body=' . $arrSettings['ssba_email_message'] . '%20' . $urlCurrentPage  . '"></a>';
...
function ssba_flattr($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("flattr", $rndid, $arrSettings);
 
    // check for dedicated flattr URL
    if ($arrSettings['ssba_flattr_url'] != '') {
    
            // set url to pre-specified URL
            $urlCurrentPage = $arrSettings['ssba_flattr_url'];
    }

    // flattr share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_flattr_share ssba_share_link" href="https://flattr.com/submit/auto?user_id=' . $arrSettings['ssba_flattr_user_id'] . '&amp;title=' . $strPageTitle . '&amp;url=' . $urlCurrentPage . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
...
function ssba_buffer($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("buffer", $rndid, $arrSettings);
 
    // buffer share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_buffer_share ssba_share_link" href="https://bufferapp.com/add?url=' . $urlCurrentPage . '&amp;text=' . ($arrSettings['ssba_buffer_text'] != '' ? $arrSettings['ssba_buffer_text'] : NULL) . ' ' . $strPageTitle . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
...
function ssba_tumblr($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("tumblr", $rndid, $arrSettings);
    ...
    // tumblr share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_tumblr_share ssba_share_link" href="http://www.tumblr.com/share/link?url=' . $urlCurrentPage . '&amp;name=' . $strPageTitle . '" ' . ($arrSettings['ssba_share_new_window'] == 'Y' ? 'target="_blank"' : NULL) . ($arrSettings['ssba_rel_nofollow'] == 'Y' ? 'rel="nofollow"' : NULL) . '></a>';
...
function ssba_print($arrSettings, $urlCurrentPage, $strPageTitle, $booShowShareCount) {
    ...
    $rndid = randCSSName();
    $htmlShareStyle = ssba_generate_service_style("print", $rndid, $arrSettings);

    // linkedin share link
    $htmlShareButtons = '<a id="'.$rndid.'" class="ssba_print ssba_share_link" href="#" onclick="window.print()"></a>';
    // return share buttons
    return $htmlShareStyle.$htmlShareButtons;
}

function randCSSName($charset='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz')
{
    $length = 7;
    $str = '';
